;(function (jQuery, window, document, undefined) {
  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.bullets) {
        ...
        self.slides().each(function(idx, el) {
          var bullet = jQuery('<li>').attr('data-orbit-slide', idx).on('click', self.link_bullet);;
    ...
    self._goto = function(next_idx, start_timer) {
      ...
      var next = jQuery(slides.get(next_idx));
    ...
    self.link_custom = function(e) {
      ...
      if ((typeof link === 'string') && (link = jQuery.trim(link)) != "") {
    ...
    self.link_bullet = function(e) {
      ...
      if ((typeof index === 'string') && (index = jQuery.trim(index)) != "") {
  ...
  var SlideAnimation = function(settings, container) {
    ...
    var is_rtl = (jQuery('html[dir=rtl]').length === 1);
  ...
  Foundation.libs.orbit = {
    ...
    reflow : function () {
      ...
      if (self.S(self.scope).is('[data-orbit]')) {
        var jQueryel = self.S(self.scope);
        var instance = jQueryel.data(self.name + '-instance');
        instance.compute_dimensions();
      } else {
        self.S('[data-orbit]', self.scope).each(function(idx, el) {
          var jQueryel = self.S(el);
          var opts = self.data_options(jQueryel);
          var instance = jQueryel.data(self.name + '-instance');
          instance.compute_dimensions();
        });
      }
