		<div class="newsletter-div"><div class="newsletter-box .flex_column.av_one_full.first.avia-builder-el-1.el_after_av_textblock.el_before_av_one_third.column-top-margin"><h2>Želim primati newsletter!</h2><?php
